            ...
            bucket.upload('/tmp/' + files.file.name, {
                ...
                if (!err) {
                    admin.database().ref('posts').push({
                        ...
                        .then(function () {
                            webpush.setVapidDetails('mailto:business@academind.com', 'BI5YZulve60bzJ58w3KkRwxuChlFV_HjPaYeUftq6QKda0sWuNXlk7YhCkeoNjBQza3OCHRlMw6WEqOXYd5PFek', 'HiLuVcnBs-fnmVFPMhhlJCPjpt-LoEcB1RiIeNvVDYE');
